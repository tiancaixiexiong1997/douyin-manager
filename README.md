...
- [系统架构](#3-系统架构)
- [本地安装](#6-本地安装)
- [VPS 一键安装](#7-全新-vps-一键安装)
- [Douyin Cookie 怎么获取](#10-douyin-cookie-怎么获取)
- [新用户怎么用](#11-新用户应该怎么使用这个项目)
- [日常更新代码](#12-日常更新代码)
- [常见问题](#14-常见问题)
- [相关文档](#16-相关文档)
...
1. 登录后台并修改管理员密码
2. 到“设置 -> 基础配置”填 `AI_API_KEY`
3. 到“设置 -> 爬虫与认证”填或提取 `Douyin Cookie`

## 场景对照

| 你现在要做什么 | 推荐入口 | 说明 |
| --- | --- | --- |
| 先把系统跑起来 | 本地安装 / VPS 一键安装 | 先保证服务、登录、任务中心正常 |
| 找对标账号 | 博主 IP 库 | 添加 3-5 个同赛道博主最合适 |
| 生成账号定位 | 策划工作台 | 通过互动问诊和参考博主生成策划 |
| 规划未来 30 天内容 | 项目详情 | 直接查看和编辑内容日历 |
| 为某条内容写脚本 | 项目详情 / 脚本提取 | 从内容条目继续生成脚本 |
| 看发出去的内容效果 | 项目详情 -> 回流 | 录入播放、互动、转化等数据 |
| 做下一轮优化 | AI 自动复盘 | 看继续放大什么、优化什么 |
...
| 模块 | 能做什么 | 最适合谁 |
| --- | --- | --- |
| 设置 | 配置 AI、Cookie、系统开关 | 管理员 / 运维 |
| 博主 IP 库 | 对标采集、爆款归因、代表作分析 | 运营 / 策划 |
| 策划工作台 | 新建项目、账号定位、生成日历 | 策划 / 项目负责人 |
| 项目详情 | 查看日历、录回流、AI 复盘、生成下一批选题 | 运营 / 策划 |
| 脚本提取 | 拆爆款、做复刻脚本 | 编导 / 运营 |
| 任务中心 | 查任务、重试失败任务 | 运营 / 运维 |
